...
function RideDetails() {
            ...
            try {
                ...
                setRide({
                    ...
                    driver: {
                        ...
                        first_name: "Janusz",
                        last_name: "Tracz",
                        username: "tracz_janusz",
                        stats: { rating_avg: 4.8, rating_count: 12 },
                    },
    ...
    const renderDriverRating = (driver) => {
        ...
        if (ratingCount < 1) {
            return <p className="text-sm text-gray-500">Brak ocen</p>;
        }
                    ...
                    <div className="space-y-6 md:col-span-2">
                        ...
                        <div className="flex flex-col gap-4 rounded-xl bg-white p-5 shadow-md sm:p-6 md:flex-row md:items-center md:justify-between">
                            ...
                            <div className="text-left md:text-right">
                                ...
                                <p className="font-bold">{carLabel}</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <button
                                    ...
                                    try {
                                        ...
                                        await showNotice({
                                            ...
                                            message: "Udało się! Zarezerwowałeś przejazd.",
                                            tone: "success",
                                        });
                                        navigate("/my-rides");
                                    } catch (err) {
                                        const errorMsg = err.response?.data?.error || "Wystąpił błąd podczas rezerwacji.";
                                        if (errorMsg === "Nie możesz zarezerwować własnego przejazdu.") {
                                            await showNotice({
                                                title: "To Twój przejazd",
                                                message: "Nie możesz zarezerwować własnego przejazdu.",
                                                tone: "warning",
                                            });
                                            return;
                                        }
