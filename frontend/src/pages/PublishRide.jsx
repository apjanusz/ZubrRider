...
function PublishRide() {
    ...
    return (
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg border-t-4 border-zubr-gold">
            <h1 className="text-3xl font-bold text-zubr-dark mb-8 text-center flex items-center justify-center gap-3">
                Dodaj nowy przejazd
            </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-gray-50 p-5 rounded-lg border border-gray-100">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        <div className="col-span-4 md:col-span-2 relative">
                            <input name="start_city" placeholder="Miasto" required onChange={handleChange}
                ...
                <div className="bg-gray-50 p-5 rounded-lg border border-gray-100">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        <div className="col-span-4 md:col-span-2">
                            <input name="end_city" placeholder="Miasto" required onChange={handleChange}
                                className="w-full p-2.5 border rounded focus:ring-2 focus:ring-zubr-gold outline-none text-sm" />
                        </div>
                        <div className="col-span-3 md:col-span-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <input type="number" name="price" placeholder="0.00" min="0" step="0.01" required onChange={handleChange}
                            className="w-full p-2.5 border rounded focus:ring-2 focus:ring-zubr-gold outline-none text-sm" />
                    </div>
                    <div className="space-y-1">
                        <label className="text-xs font-bold text-gray-500 uppercase flex items-center gap-2 mb-1">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <select name="car_id" className="w-full p-3 border rounded bg-white focus:ring-2 focus:ring-zubr-gold outline-none text-sm appearance-none" onChange={handleChange}>
                            {cars.map(car => (
                                <option key={car.id} value={car.id}>
                                    {car.brand} {car.model} — {car.seats} os. ({car.license_plate})
                                </option>
                            ))}
                        </select>
